...
class Draft:
    ...
    # Generates 75 rookies for the draft class
    ...
    # Calculates a rookie's salary based on where they were taken in the draft
    ...
    # Displays every rookie in the draft
