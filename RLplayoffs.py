...
class Playoffs:
    ...
    # Determines the seeding for the playoffs, division winners determine tiebreakers
    ...
    # Creates the playoff bracket and handles the simulation
    ...
    # simulates a playoff series in a best of 4
